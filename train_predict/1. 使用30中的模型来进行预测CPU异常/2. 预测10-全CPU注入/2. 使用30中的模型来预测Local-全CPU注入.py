...
if __name__ == "__main__":
    ...
    spath = "tmp/30模型预测总集合/2.2.预测10数据-Local"
    # 模型路径
    ...
    abnormaliTime = [
        [c("2021-06-29 19:36:00"), c("2021-06-29 19:45:00"), 11],
        [c("2021-06-29 20:06:00"), c("2021-06-29 20:15:00"), 12],
        [c("2021-06-29 20:36:00"), c("2021-06-29 20:45:00"), 13],
        [c("2021-06-29 21:06:00"), c("2021-06-29 21:15:00"), 14],
    ...
    # 为了防止时间过长，可以设置多个
    begin_endTime = [
        ("2021-06-29 19:26:00", "2021-06-30 03:06:00")
    ]
