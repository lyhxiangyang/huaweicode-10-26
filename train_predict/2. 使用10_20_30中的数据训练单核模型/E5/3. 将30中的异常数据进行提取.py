...
if __name__ == "__main__":
    ...
    # 要读取的filename
    rfilename = ["wrf_3km_e5-43_process-68", "wrf_3km_e5-43_process-69"]
    rtime = None
    rcores = [0, 1, 2, 3, 4, 5, 6]
