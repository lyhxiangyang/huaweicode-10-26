...
testAbnormalDataPath = [
    (10, "tmp/tData-10-26/多机-Local-server-3KM/9.特征提取所有错误-处理首尾/13.csv"),
    (10, "tmp/tData-10-26/多机-Local-server-3KM/9.特征提取所有错误-处理首尾/14.csv"),
    (10, "tmp/tData-10-26/多机-Local-server-3KM/9.特征提取所有错误-处理首尾/15.csv"),
]
