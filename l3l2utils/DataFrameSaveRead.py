...
def getServer_Process_l2_NetworkList(dirpath: str, server_feature=None, process_feature=None, l2_feature=None,
                                     network_feature=None, isExistFlag: bool = True, ) -> tuple[
