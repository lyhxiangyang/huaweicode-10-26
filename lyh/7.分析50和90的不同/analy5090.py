...
topdownfilepath = [
    ...
    "DATA/2022-01-14新的测试数据/28.grapes_test_multi_l3/centos16/topdown/topdown.csv",
...
serverfilepath = [
    ...
    "DATA/2022-01-14新的测试数据/28.grapes_test_multi_l3/centos11/server/metric_server.csv",
]
