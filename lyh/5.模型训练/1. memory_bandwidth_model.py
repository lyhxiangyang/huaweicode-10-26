...
if __name__ == "__main__":
    ...
    traindatapath = os.path.join(nowpath, "model_grapes.csv")
    ...
    # =============================================================
    model_train(trainpd, MODEL_TYPE[0], saved_model_path=savemodelpath, trainedFeature=trainFeatures, maxdepth=3)
