...
dataserverpath = [
    R"D:\HuaweiMachine\数据分类\TrainAndTest\测试数据\B\local环境\标注数据\local_wrf\wrf_3km_multi\wrf_160\wrf_local_160_server.csv",
]
...
if __name__ == "__main__":
    spath = "tmp/tData-11-09/测试数据/多机-Local-server-3KM"
    all_faulty_pd_dict = {}
