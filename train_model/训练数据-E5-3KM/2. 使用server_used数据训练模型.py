...
trainNormalDataPath = [
    R"tmp/11-19-tData/训练数据-E5-3km/server/4. server上数据异常信息集合/0.csv",
]

trainAbnormalDataPath = [
    (60, R"tmp/11-19-tData/训练数据-E5-3km/server/4. server上数据异常信息集合/61.csv"),
    (60, R"tmp/11-19-tData/训练数据-E5-3km/server/4. server上数据异常信息集合/62.csv"),
    (60, R"tmp/11-19-tData/训练数据-E5-3km/server/4. server上数据异常信息集合/63.csv"),
    (60, R"tmp/11-19-tData/训练数据-E5-3km/server/4. server上数据异常信息集合/64.csv"),
    (60, R"tmp/11-19-tData/训练数据-E5-3km/server/4. server上数据异常信息集合/65.csv"),
]
...
if __name__ == "__main__":
    ...
    ModelTrainAndTest(allTrainedPD, None, spath=spath, selectedFeature=allfeatureload1_nosuffix, modelpath="Classifiers/saved_model/tmp_load1_nosuffix", testAgain=False)
