...
trainAbnormalDataPath = [
    (50, R"tmp/11-19-tData/训练数据-E5-3km/server/4. server上数据异常信息集合/51.csv"),
    (50, R"tmp/11-19-tData/训练数据-E5-3km/server/4. server上数据异常信息集合/52.csv"),
    (50, R"tmp/11-19-tData/训练数据-E5-3km/server/4. server上数据异常信息集合/53.csv"),
    (50, R"tmp/11-19-tData/训练数据-E5-3km/server/4. server上数据异常信息集合/54.csv"),
    (50, R"tmp/11-19-tData/训练数据-E5-3km/server/4. server上数据异常信息集合/55.csv"),
]
