...
datapath = [
    R"D:\HuaweiMachine\数据分类\TrainAndTest\测试数据\B\e5环境\标注数据\wrf\wrf_3km_multi_9\wrf_43\wrf_e5_43_process.csv",
]
...
if __name__ == "__main__":
    spath = "tmp/tData-11-09/测试数据/多机-E5-process-3KM_89/10.提取进程文件中的CPU数据"
