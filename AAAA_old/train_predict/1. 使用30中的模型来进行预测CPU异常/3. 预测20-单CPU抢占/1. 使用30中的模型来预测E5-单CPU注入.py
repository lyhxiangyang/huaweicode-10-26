...
if __name__ == "__main__":
    ...
    spath = "tmp/30模型预测总集合/3.1.预测20数据-E5"
    # 模型路径
    rmodelpath = "Classifiers/saved_model/tmp_load1_nosuffix"
    # E5全CPU抢占-10主要分布在 64、65、66里面
    rfilenames = ["wrf_3km_e5-43_process-66", "wrf_3km_e5-43_process-67", "wrf_3km_e5-43_process-68"]
    # 要预测所有的时间段
    rtimes = None
    # 要预测所有的核心
    rcores = None
    ...
    abnormaliTime = [
        ...
        ## 67  25两者重合
        [c("2021-08-30 21:17:00"), c("2021-08-30 21:36:00"), 23],
        [c("2021-08-30 21:57:00"), c("2021-08-30 22:16:00"), 24],
        ## 68
        [c("2021-08-30 22:37:00"), c("2021-08-30 22:56:00"), 25],
        [c("2021-08-30 23:17:00"), c("2021-08-30 23:36:00"), 31],
        [c("2021-08-30 23:57:00"), c("2021-08-31 00:16:00"), 32],
    ]
    # 为了防止时间过长，可以设置多个
    begin_endTime = [
        ("2021-08-30 19:14:00", "2021-08-31 00:19:00")
    ]
