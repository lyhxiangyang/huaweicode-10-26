...
trainAbnormalDataPath = [
    ...
    # E5 20
    (30, "tmp/使用10_20_30中的数据训练单核模型/E5/4.错误码20-特征提取所有错误-处理首尾/21.csv"),
    (30, "tmp/使用10_20_30中的数据训练单核模型/E5/4.错误码20-特征提取所有错误-处理首尾/22.csv"),
    (30, "tmp/使用10_20_30中的数据训练单核模型/E5/4.错误码20-特征提取所有错误-处理首尾/23.csv"),
    (30, "tmp/使用10_20_30中的数据训练单核模型/E5/4.错误码20-特征提取所有错误-处理首尾/24.csv"),
    (30, "tmp/使用10_20_30中的数据训练单核模型/E5/4.错误码20-特征提取所有错误-处理首尾/25.csv"),
    # E5 30
    (30, "tmp/使用10_20_30中的数据训练单核模型/E5/6.错误码30-特征提取所有错误-处理首尾/31.csv"),
    (30, "tmp/使用10_20_30中的数据训练单核模型/E5/6.错误码30-特征提取所有错误-处理首尾/32.csv"),
    (30, "tmp/使用10_20_30中的数据训练单核模型/E5/6.错误码30-特征提取所有错误-处理首尾/33.csv"),
    (30, "tmp/使用10_20_30中的数据训练单核模型/E5/6.错误码30-特征提取所有错误-处理首尾/34.csv"),
    (30, "tmp/使用10_20_30中的数据训练单核模型/E5/6.错误码30-特征提取所有错误-处理首尾/35.csv"),
]
...
testAbnormalDataPath = [
    ...
    # Local 20
    (30, "tmp/使用10_20_30中的数据训练单核模型/Local/4.错误码20-特征提取所有错误-处理首尾/21.csv"),
    (30, "tmp/使用10_20_30中的数据训练单核模型/Local/4.错误码20-特征提取所有错误-处理首尾/22.csv"),
    (30, "tmp/使用10_20_30中的数据训练单核模型/Local/4.错误码20-特征提取所有错误-处理首尾/23.csv"),
    (30, "tmp/使用10_20_30中的数据训练单核模型/Local/4.错误码20-特征提取所有错误-处理首尾/24.csv"),
    (30, "tmp/使用10_20_30中的数据训练单核模型/Local/4.错误码20-特征提取所有错误-处理首尾/25.csv"),
    # local 30
    (30, "tmp/使用10_20_30中的数据训练单核模型/Local/6.错误码30-特征提取所有错误-处理首尾/31.csv"),
    (30, "tmp/使用10_20_30中的数据训练单核模型/Local/6.错误码30-特征提取所有错误-处理首尾/32.csv"),
    (30, "tmp/使用10_20_30中的数据训练单核模型/Local/6.错误码30-特征提取所有错误-处理首尾/33.csv"),
    (30, "tmp/使用10_20_30中的数据训练单核模型/Local/6.错误码30-特征提取所有错误-处理首尾/34.csv"),
    (30, "tmp/使用10_20_30中的数据训练单核模型/Local/6.错误码30-特征提取所有错误-处理首尾/35.csv"),
]
