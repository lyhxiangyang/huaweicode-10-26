...
trainAbnormalDataPath = [
    (50, "tmp/tData-10-26/多机-E5-server-3KM/9.特征提取所有错误-处理首尾/51.csv"),
    (50, "tmp/tData-10-26/多机-E5-server-3KM/9.特征提取所有错误-处理首尾/52.csv"),
    (50, "tmp/tData-10-26/多机-E5-server-3KM/9.特征提取所有错误-处理首尾/53.csv"),
    (50, "tmp/tData-10-26/多机-E5-server-3KM/9.特征提取所有错误-处理首尾/54.csv"),
    (50, "tmp/tData-10-26/多机-E5-server-3KM/9.特征提取所有错误-处理首尾/55.csv"),
]
...
if __name__ == "__main__":
    ...
    ModelTrainAndTest(allTrainedPD, allTestPD, spath=spath, selectedFeature=allfeatureload1_nosuffix, modelpath="Classifiers/saved_model/tmp_load1_nosuffix", maxdepth=10)
