...
testAbnormalDataPath = [
    (60, "tmp/tData-10-26/多机-Local-server-3KM/7.特征提取所有错误-未处理首尾/61.csv"),
    (60, "tmp/tData-10-26/多机-Local-server-3KM/7.特征提取所有错误-未处理首尾/62.csv"),
    (60, "tmp/tData-10-26/多机-Local-server-3KM/7.特征提取所有错误-未处理首尾/63.csv"),
    (60, "tmp/tData-10-26/多机-Local-server-3KM/7.特征提取所有错误-未处理首尾/64.csv"),
    (60, "tmp/tData-10-26/多机-Local-server-3KM/7.特征提取所有错误-未处理首尾/65.csv"),
]
...
if __name__ == "__main__":
    ...
    # trainAbnormalList = [ sortByAbsValue(ipd, "used_mean", 100).loc[0: lenAbnormalData, :] for ipd in trainNormalList]
    #==================================================================end
