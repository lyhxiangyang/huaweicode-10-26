...
dataserverpath = [
    R"D:\HuaweiMachine\数据分类\TrainAndTest\测试数据\B\hpc环境\标注数据\hpc_wrf\wrf_3km_multi\hpcagent18\wrf_hpc_hpcagent18_server.csv",
    R"D:\HuaweiMachine\数据分类\TrainAndTest\测试数据\B\hpc环境\标注数据\hpc_wrf\wrf_3km_multi\hpcagent18\wrf_hpc_hpcagent18_server-9.csv",
]
