...
dataserverpath = [
    R"D:\HuaweiMachine\数据分类\TrainAndTest\训练数据\B\local环境\多机\wrf_3km_多机\part1\output\local_160\wrf_3km_160_server.csv",
    R"D:\HuaweiMachine\数据分类\TrainAndTest\训练数据\B\local环境\多机\wrf_3km_多机\part2\output\local_160\wrf_3km_160_server.csv",
]
