...
datapath = [
    ...
    R"D:\HuaweiMachine\数据分类\TrainAndTest\训练数据\B\e5环境\标注数据\wrf\wrf_3km_multi\wrf_43\wrf_e5_43_process-89.csv",
]
...
if __name__ == "__main__":
    spath = "tmp/tData-11-09/训练数据/多机-E5-process-3KM/10.提取进程文件中的CPU数据"
