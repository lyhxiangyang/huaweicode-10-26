...
5.如果有正常数据，显示正常数据的平均值
"""
def getCacheGrab90Debuginfo(serverpd: pd.DataFrame, processpd: pd.DataFrame, topdownpd: pd.DataFrame, inputDict: Dict = None, detectionJson: Dict = None) -> pd.DataFrame:
    debugpd = pd.DataFrame()
