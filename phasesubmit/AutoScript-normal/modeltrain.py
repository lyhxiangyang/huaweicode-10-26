...
if __name__ == "__main__":
    ...
    # 保证50和90某个出现一个就行
    if isFlagsOr(abnormalDataDict["server"],
                 configJsonDict["memorybandwidthlabels"] + configJsonDict["cachegrablabels"]):
    ...
    if isFlagsOr(abnormalDataDict["server"],
                 configJsonDict["randomcpulabels"] + configJsonDict["memorybandwidthlabels"] + configJsonDict[
                     "cachegrablabels"]):
        # 得到randomcpu
