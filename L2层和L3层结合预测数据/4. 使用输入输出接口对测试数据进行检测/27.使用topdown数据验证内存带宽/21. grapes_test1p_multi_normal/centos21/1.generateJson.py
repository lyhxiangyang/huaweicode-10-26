...
if __name__ == "__main__":
    ...
    # 其中单个server文件我默认是连续的
    predictdirpath = R"DATA/2022-01-14新的测试数据/21.grapes_test1p_multi_normal/centos21"
    ...
    normalMeanDict = {
        ...
        "l2": {
            # "CPU_Powewr": 789.5757575757576,haoba
    ...
    # ========================================================= 进行读取
    jsonDict = covertCSVToJsonDict(predictdir=predictdirpath, normalMeanDict=normalMeanDict,type="grape")
