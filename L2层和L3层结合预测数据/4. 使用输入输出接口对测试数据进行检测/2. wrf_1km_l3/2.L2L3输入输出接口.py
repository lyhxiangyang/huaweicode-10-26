...
def FeatureextractionData(inputDict: Dict):
    ...
    normalserver_meanvalue = getNormalServerMean(detectionJson, predictserverpds, predictprocesspds, inputDict["server_feature"], datanumber=inputDict["meanNormalDataNumber"])
