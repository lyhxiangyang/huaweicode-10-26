...
if __name__ == "__main__":
    ...
    # 模型保存路径
    bandwidth_modelpath = R"tmp/modelpath/grape_local_memory_bandwidth_model"
    # 将一些需要保存的临时信息进行保存路径
    spath = "tmp/模型训练中间数据/2.Local-GRAPES-内存带宽"
    ...
    # 将used和pgfree修改为指定值
    normalserver_meanvalue["mem_used"] = 27500000000
